...
| 8  | [3진법 뒤집기 (Lv1)](https://school.programmers.co.kr/learn/courses/30/lessons/68935)        | 컴프리헨션 + `join()` + `int(..., 3)` | [ ] |
...
| 순서 | 문제명                                                                         | 핵심 문법    | 체크  |
| -- | --------------------------------------------------------------------------- | -------- | --- |
| 1  | [예산 (Lv1)](https://school.programmers.co.kr/learn/courses/30/lessons/12982) | 정렬 + 누적  | [ ] |
